...
def main():
    ...
    Example: master_intfs.py S1_20170905_ALL_F2.SLC
    """
    ...
    for i, PRM in enumerate(prms):
        if i < m:
            ...
            print('intf.csh {} {} -topo_ra.grd'.format(supermaster, PRM))
            # subprocess.call('intf.csh {} {} -topo_ra.grd'.format(supermaster, PRM), shell=True)
